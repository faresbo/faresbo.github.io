...
$(document).on("click",".p2 .btn-toggle-ans-cor",function  ( e ) {
 ...
 if( !$(this).hasClass("active") ){
  ...
  var data_ans = $(".p2").attr("data_ans");
  data_ans = (data_ans);
  data_ans = parseInt(data_ans);
  $(".chkimg").css("box-shadow",'none');
  $(".chkimg").removeClass("active");
  console.log( data_ans);

if( data_ans ){
  $(".chkimg").eq(data_ans-1).addClass("active");
}
...
$(document).on("click", ".p2 .btn-Checker",function  (e) {
...
$(document).on("click", ".p3 .btn-Checker",function  (e) {
...
$(document).on("click", ".p4 .btn-Checker",function  (e) {
