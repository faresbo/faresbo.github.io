...
function __$(e, t, u, x = (h) => h) {
  ...
  function ce(e, t = {}) {
	...
	let p = e[e.length - 1].runningLength, g = f.taper === false ? 0 : f.taper === true ? Math.max(u, p) : f.taper, T = d.taper === false ? 0 : d.taper === true ? Math.max(u, p) : d.taper, te = Math.pow(u * x, 2), _ = [], M = [], H = e.slice(0, 10).reduce((r, i) => {
	  ...
	  return (r + o) / 2;
	}, e[0].pressure), m = __$(u, h, e[e.length - 1].pressure, n), U, X = e[0].vector, z = e[0].point, F = z, O = z, E = F, J = false;
  ...
  var _e = ae;
  //export default _e;
  //export {ae as getStroke, ce as getStrokeOutlinePoints, me as getStrokePoints};
