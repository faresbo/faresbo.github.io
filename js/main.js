...
function LoadFile () {
var online_file = window.location.search;
if( online_file.length > 0){
  online_file = online_file.substring(5,online_file.length);


  $("#loader").show();
  var xhr = new XMLHttpRequest();
  xhr.open('GET', "https://cors-anywhere.herokuapp.com/"+online_file, true);
  ...
  xhr.onprogress = function(e) {
    ...
    $("#msg").html(parseInt(percent_complete)+" %")
  };
...
async function openRemoteFile (file) {
   var  indexjson = await getIndexJson(file); 
...
$(document).on("click","#open-file",async function (e) {
...
var data_ls_text = `
<script>
//document.body.setAttribute("id","dd")
(function() {
